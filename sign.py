...
def main():
    ...
    message1.add_font(
        "dejavu", "/usr/share/fonts/truetype/dejavu/DejaVuSans.ttf", 14)
    message1.set_stroke(1, (255, 255, 255))
    message1.add_text("Bianca!", color=(255, 0, 0))
    message1.set_shadow()
    ...
    message2.add_text("Good", color=(17, 237, 17), y_offset=-2)
    message2.set_shadow()
